...
(function (a, b, c, d) {
  function l(b, c) {
    this.element = b;
    this.options = a.extend(true, {}, g, c);
  ...
  var f = "sharrre", g = {
    ...
    googlePlus: function (d) {
      ...
      if (typeof twttr === "undefined" && e == 0) {
        ...
        a.ajax({url: "//platform.twitter.com/widgets.js", dataType: "script", cache: true})
      }
    }, digg: function (b) {
      ...
      var e = 0;
      if (typeof __DBW === "undefined" && e == 0) {
        e = 1;
        (function () {
          var a = c.createElement("SCRIPT"), b = c.getElementsByTagName("SCRIPT")[0];
          a.type = "text/javascript";
          a.async = true;
      ...
      if (b.options.buttons.delicious.size == "tall") {
        var c = "width:50px;", d = "height:35px;width:50px;font-size:15px;line-height:35px;", e = "height:18px;line-height:18px;margin-top:3px;"
      } else {
        var c = "width:93px;", d = "float:right;padding:0 3px;height:20px;width:26px;line-height:20px;", e = "float:left;height:20px;line-height:20px;"
      }
      ...
      var f = 0;
      if (typeof STMBLPN === "undefined" && f == 0) {
        f = 1;
        (function () {
          var a = c.createElement("script");
          a.type = "text/javascript";
    ...
    googlePlus: function (a) {
      ...
      b.open("http://www.facebook.com/sharer.php?u=" + encodeURIComponent(a.buttons.facebook.url !== "" ? a.buttons.facebook.url : a.url) + "&t=" + a.text + "", "", "toolbar=0, status=0, width=900, height=500")
    }, twitter: function (a) {
  ...
  l.prototype.init = function () {
    ...
    if (this.options.urlCurl !== "") {
      h.googlePlus = this.options.urlCurl + "?url={url}&type=googlePlus";
      h.stumbleupon = this.options.urlCurl + "?url={url}&type=stumbleupon";
      h.pinterest = this.options.urlCurl + "?url={url}&type=pinterest"
    }
    a(this.element).addClass(this.options.className);
    if (typeof a(this.element).data("title") !== "undefined") {
      this.options.title = a(this.element).attr("data-title")
    }
    if (typeof a(this.element).data("url") !== "undefined") {
      this.options.url = a(this.element).data("url")
    }
    if (typeof a(this.element).data("text") !== "undefined") {
      this.options.text = a(this.element).data("text")
    }
    a.each(this.options.share, function (a, c) {
      if (c === true) {
        b.options.shareTotal++
      }
    });
    if (b.options.enableCounter === true) {
      a.each(this.options.share, function (a, c) {
        if (c === true) {
          try {
            b.getSocialJson(a)
    ...
    } else if (b.options.template !== "") {
      this.options.render(this, this.options)
    } else {
      this.loadButtons()
    }
    a(this.element).hover(function () {
      if (a(this).find(".buttons").length === 0 && b.options.enableHover === true) {
        b.loadButtons()
      }
  ...
  l.prototype.loadButtons = function () {
    ...
    a.each(b.options.share, function (a, c) {
      if (c == true) {
        i[a](b);
        if (b.options.enableTracking === true) {
          j[a]()
        }
      }
    })
  ...
  l.prototype.getSocialJson = function (b) {
    var c = this, d = 0, e = h[b].replace("{url}", encodeURIComponent(this.options.url));
    if (this.options.buttons[b].urlCount === true && this.options.buttons[b].url !== "") {
      e = h[b].replace("{url}", this.options.buttons[b].url)
    }
    if (e != "" && c.options.urlCurl !== "") {
      a.getJSON(e, function (a) {
        if (typeof a.count !== "undefined") {
          var e = a.count + "";
          e = e.replace("Â ", "");
          d += parseInt(e, 10)
        } else if (typeof a.likes !== "undefined") {
          d += parseInt(a.likes, 10)
        } else if (typeof a.shares !== "undefined") {
          d += parseInt(a.shares, 10)
        } else if (typeof a[0] !== "undefined") {
          d += parseInt(a[0].total_posts, 10)
        } else if (typeof a[0] !== "undefined") {
        }
        c.options.count[b] = d;
        c.options.total += d;
  ...
  l.prototype.renderer = function () {
    ...
    if (this.options.shorterTotal === true) {
      b = this.shorterTotal(b)
    }
    if (c !== "") {
      c = c.replace("{total}", b);
      a(this.element).html(c)
    } else {
      a(this.element).html('<div class="box"><a class="count" href="#">' + b + "</a>" + (this.options.title !== "" ? '<a class="share" href="#">' + this.options.title + "</a>" : "") + "</div>")
    }
  };
    ...
    if (b === d || typeof b === "object") {
      return this.each(function () {
        if (!a.data(this, "plugin_" + f)) {
          a.data(this, "plugin_" + f, new l(this, b))
        }
      })
    } else if (typeof b === "string" && b[0] !== "_" && b !== "init") {
      return this.each(function () {
        var d = a.data(this, "plugin_" + f);
        if (d instanceof l && typeof d[b] === "function") {
